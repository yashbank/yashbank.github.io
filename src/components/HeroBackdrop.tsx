    ...
    <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden" aria-hidden>
      <picture className="absolute inset-0 block h-full min-h-[100svh] w-full">
        ...
        <img
          ...
          decoding="async"
          sizes="100vw"
          className="absolute inset-0 h-full min-h-[100svh] w-full object-cover object-[center_22%] opacity-[0.38] transition-[transform,opacity] duration-[1.6s] ease-[cubic-bezier(0.22,1,0.36,1)] md:object-center md:opacity-[0.34] group-hover/hero:scale-[1.028]"
        />
      </picture>
      <div className="absolute inset-0 bg-surface/35" />
      <div className="absolute inset-0 bg-gradient-to-b from-surface/92 via-surface/68 to-surface/90" />
      <div className="absolute inset-0 bg-gradient-to-tr from-accent/[0.05] via-transparent to-vermillion/[0.035]" />
